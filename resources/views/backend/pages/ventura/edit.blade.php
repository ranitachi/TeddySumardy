	...
	<div class="col-md-12">
        <div class="widget">
            ...
            <div class="widget-body">
                <form action="{{ route('ventura.update', $data->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        <label>Sejarah</label>
                        <textarea name="sejarah" id="ckeditor" cols="30" rows="10">{{ $data->sejarah }}</textarea>
                    </div>
                    <div class="form-group">
                        <label>Visi Misi</label>
                        <textarea name="visi_misi" class="ckeditor" cols="30" rows="10">{{ $data->visi_misi }}</textarea>
                    </div>
                    <div class="form-group">
                        <label>Deskripsi</label>
                        <textarea name="deskripsi" class="ckeditor" cols="30" rows="10">{{ $data->deskripsi }}</textarea>
                    </div>
                    <br>
